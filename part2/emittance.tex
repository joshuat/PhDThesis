...
The beam current of the short duration streaks correlates strongly with the intensity of the blue laser as shown in Figure~\ref{figure:blue_streak}.

\begin{figure}
    \center
    \input{part2/Figs/blue_electrons.pgf}
    \caption{A comparison of an electron streak to the blue laser pulse used to ionise the atoms.
    The top portion shows the electron streak across the detector, the middle portion shows the intensity of the blue laser, and the bottom portion shows the electron count calculated by suming the columns of the streak image.}
...
\section{Simulations}\label{section:pepperpot_simulation}
...
\section{Results}
In order to demonstrate the feasibility of time-resolved brightness measurements via the streaking of pepperpots a number of measurements have been made including a comparison of two-dimensional pepperpot emittance measurements with theory and slow and fast streaks used to determine the time-resolved brightness of electron bunches produced by the \gls{caes}.
These measurement also provide an opportunity to examine the emittance behaviour of the \gls{caes} under a limited set of ionisation conditions.
...
\begin{figure}
    ...
    \caption{Long (left) and short (right) duration electron bunch streaked pepperpot measurements showing, from top to bottom, the false-colour streak image, full-beam current, normalised \gls{rms} emittance, and normalised brightness. The dotted black lines indicate the start of the electron bunches. The red dotted lines in the emittance measurement indicate the expected emittance from the simulations discussed in Section~\ref{section:pepperpot_simulation}. The shaded regions indicate the standard deviation of ten 100-shot measurements.}
...
\section{Conclusion}
This chapter has presented an demonstration of time-resolved brightness measurements using streaked pepperpots with a \gls{caes}.
...
\section{To Do}
\begin{itemize}
    \item Mention expected outcome, results
    \item Better conclusion
