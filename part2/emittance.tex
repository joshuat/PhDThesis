...
The deflection gradient for the image can then be calculated as
\begin{equation}
...
The maximum extent of the pepperpot masks were limited to the diameter accessible by the beam, \unit[2]{mm}.
...
Fitting to the simulations, which replicate the geometry of the apparatus used here, indicates that for this apparatus $k=0.75\pm0.02$.
