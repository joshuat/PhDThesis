...
The code of the simulations is shown in Appendix~\ref{appendix:code}.
...
If the pepperpot mask measuring the beam is not at a beam waist then, due to the beam divergence, the correction shown in Equation~\ref{equations:emittance_correction_simple} is not suitable.
...
The corrected emittance agrees well with the known emittance for the beam provided the extend of the pepperpot array is larger than the \gls{rms} beam width.
...
The central code for the analysis is given in Appendix~\ref{appendix:code}.
