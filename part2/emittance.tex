...
This was achieved by manual adjusting the positions of the magnets, which were mounted on posts external to the vacuum system, to ensure that the beam was passing through the apertures in the system and by scanning the Einzel lens to verify that the beam was passing through its centre.
...
low energy is preferable for resolution, beam alignment oo fragile, flux was lower

higher energy provided a significantly more stable beam and higher flux, difference in resolution is small maybe, do some math
