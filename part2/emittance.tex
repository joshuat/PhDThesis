...
The pepperpots were cut from \unit[25]{$\mu m$} thick copper pinhole sample with \unit[50]{$\mu m$} diameter holes cut in the centre {\color{red}(make and model #)}.
