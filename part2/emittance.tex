...
To simplify matters here only the In order to extrapolate this estimate to the number of electron required for single-shot streaked emittance measurements....
