...
\begin{figure}
    ...
    \caption[Pepperpot measurements with and without beam astigmatism correction.]{An example of a electrons after the pepperpot mask without the beam correction from the quadrupole lens. It is readily apparent that spacing of the beamlets is not the same for the $x$ and $y$ axes even though the spacing in the pepperpot mask was symmetric. This image is log scaled.}
