...
An example of the trace-space occupied by a beam is shown in Fig.~\ref{figure:emittance_example}.
...
An example pepperpot mask and detected beamlets are shown in Fig.~\ref{figure:pepperpot_example}.
This equation can be implemented by appropriately rotating the detected beamlets and then performing row and column sums of the pixels followed by application of Eq.~\ref{equation:pepperpot} for $x$ and $y$.
...
\end{equation}
and then Eq.~\ref{equation:multiprofile} becomes
\begin{equation}
