...
One method is to use a gated systems where the detector is only turned on for a short interval and the interval is adjusted from shot-to-shot to build up the temporal behaviour of the emittance measurement~\cite{bekefi_temporal_1987,yoshida_simple_2001}.
Another method is \gls{otr} which examines the radition from a thin foil......

The method is that can be used to achieve time-resolution for emittance measurements is streaking.
