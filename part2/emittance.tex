...
According to some brief simulations, shown in Figure~\ref{figure:gaussian_minimum}, in order to determine the mean and standard deviation of a Gaussian to 90\% accuracy requires {\color{red}finish this tomorrow....}
