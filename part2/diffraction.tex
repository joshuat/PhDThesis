...
\begin{align}\label{equation:recip_basis}
...
\end{align}
In Equation~\ref{equation:recip_basis}, the $2\pi$ originates from the convention chosen for the wave-vector, $|\mathbf{k}|=2\pi/\lambda$. The reciprocal lattice vector is thus
\begin{equation}
...
Under similar conditions, the shape of the electron bunches was determined to have a Gaussian shape with a \gls{fwhm} of \unit[1.4]{mm} with a divergence of $\sigma_{\theta_x}=0.3\,\muup$rad and thus a source emittance of $\epsilon_x=50$\,nm\,rad~\cite{speirs_single-shot_2015}.
