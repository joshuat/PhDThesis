...
There were a number of pathways available to ionise the atoms trapped in the \gls{mot} each with different bunch temperatures and duration\cite{speirs_electron_2017}.
