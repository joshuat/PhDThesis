...
The electric field after the polariser is then
\begin{align}
...
\begin{align}
\vec{E} = E_0 \left[\frac{1}{2} +\frac{\Phi-4d\phi}{2}-\frac{\Phi^2}{4}\right]\hat{x} \,\,+ \notag\\
E_0 \left[\frac{\Phi}{2}-\frac{1}{4}\big(1-\frac{(\Phi+2d\phi)^2}{2}\big)+\frac{3}{4}\big(1-\frac{(\Phi-2d\phi)^2}{2}\big)\right]\hat{y}.
\end{align}
