...
& 2\sqrt{P_cP_s} \, \operatorname{Im}\Bigg[ F_R(\omega)F_R^*(\omega+\Omega)-F_R^*(\omega)F_R(\omega-\Omega)\Bigg]\cdot\sin\Omega t &+ \qquad&O[2\Omega],
\end{align}
...
{\color{red}Up to here. Should probably not be lazy and do the multiplication.}
