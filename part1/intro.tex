...
The blue line is the absorption spectrum and the green line is the error signal for modulated \gls{sa}. The two leftmost and the rightmost bumps in the absorption spectrum are the $F=3$ to $F'=1,2,3$ transitions respectively and the other two larger features are the cross-overs for the $F=3$ to $F'=1,3$ and $F'=2,3$ transitions.}
