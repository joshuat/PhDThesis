...
The simplest and most reliable method, two-laser heterodyne, indicates that the laser linewidth achieveable with this laser freqeuncy stabilisation technique is \unit[0.6$\pm$0.1]{kHz}, well below preivously demonstrated with \gls{ps}.
...
(i) Mapping the transmission signal through a cavity with a FWHM of \unit[71.6]{kHz} to a Lorentzian signal followed by deconvolving from the amplitude noise.
...
(iv) Long-term stability measured with the optical cavaity, Figure~\ref{figure:ps_drift}.}
...
Further improvements to spectral linewidth could be improved if the noise in the \gls{ps} measurement can be decreased and the signal strength improved allowing for lower shot-noise and greater nosie suppression.
Drift can be expected to improve with active temperature stabilisation of the atomic gas cells, active laser-power stablisation into the \gls{ps} setup, and free space propagation rather than the use of optical fibres.
