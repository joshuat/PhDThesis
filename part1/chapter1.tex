...
\caption{An example of a saturated absorption spectroscopy absorption spectrum for the rubidium-85 D2 transition. The red line is the absorption spectrum and the blue line is the error signal for modulated \gls{sa}.}
