...
This can range from weak frequency stabilisation keeping a laser's centre frequency at a particular point to convoluted frequency narrowing techniques that attempt to reduce laser linewidth to sub-hertz levels.
...
\item H\"ansch Couillaud~\cite{hansch_laser_1980}.
\end{itemize}
