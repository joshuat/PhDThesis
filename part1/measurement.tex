...
{\color{red} Remove this section once the others are written.}
...
The two beams are still correlated so it is necessary to propagate one beam for long enough to reduce the coherence otherwise the lineshape of the beatnote would just appear as a delta function centred at the \gls{aom} frequency.
