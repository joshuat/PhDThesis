...
The result of this is that while \glspl{xfel} require a large several kilometer long facility with a billion dollar price tag a hypothetical electron source with similar capabilities would likely fit in a room with a much lower cost, current \gls{caes} implementations easily fit on a single optical bench.
...
{\color{red} Write this section when I've finished the reast of the thesis. Make up my mind as to whether to have two parts or not.}
