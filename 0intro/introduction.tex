...
A new method for measuring time-resolved emittance by streaking one-dimensional pepperpots is presented in Chapter~\ref{chapter:brightness} and published in Reference~\cite{torrance_time-resolved_2018} providing a useful technique for investigating the ionisation processes involved in a \gls{caeis} and characterising the performance of techniques to counter space-charge degradation of bunches produced by \glspl{caeis}.
