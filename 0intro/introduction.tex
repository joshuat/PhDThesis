...
{\color{red}Some more details on damage, a few machanisms and timscales.}
...
An isolated atom, such as that in the ultracold gas, has a much more limited range of potential outcomes: absorption of the photon, radiative decay or ionisation.
Each process is well understood thus allowing the optimisation of the quantum efficiency~\cite{baranov_field_1994}.
